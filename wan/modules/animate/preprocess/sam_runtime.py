...
PREPROCESS_RUNTIME_PROFILES = {
    ...
    "h200_extreme": {
        ...
        "face_bbox_smooth_strength": 0.86,
        "face_bbox_max_scale_change": 1.08,
        "face_bbox_max_center_shift": 0.02,
        "face_bbox_hold_frames": 10,
        "pose_smooth_strength_body": 0.78,
        "pose_smooth_strength_hand": 0.45,
        "pose_smooth_strength_face": 0.82,
        "person_roi_stage_resolution_area": [2048, 1152],
        "person_roi_stage_min_short_side": 1024,
        "person_roi_target_long_side": 1792,
        "person_roi_fuse_weight": 0.78,
        "person_roi_conf_margin": 0.0,
        "face_roi_stage_resolution_area": [2048, 1152],
        "face_roi_stage_min_short_side": 1152,
        "face_roi_target_long_side": 1024,
        "face_roi_fuse_weight": 0.70,
        "face_roi_conf_margin": 0.0,
        "multistage_pose_extra_smooth": 0.18,
        "multistage_face_bbox_extra_smooth": 0.16,
        "sam_apply_postprocessing": False,
        "sam_chunk_len": 20,
        "sam_keyframes_per_chunk": 4,
        "sam_use_negative_points": False,
