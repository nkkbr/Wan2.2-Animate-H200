...
class ProcessPipeline():
    ...
    def __call__(
        ...
        external_alpha_model_id=None,
        external_alpha_blend=0.35,
        external_alpha_delta_clip=0.08,
        external_alpha_hair_boost=0.12,
        ...
        if replace_flag:
            ...
            matting_output = run_matting_adapter(
                frames=np.stack(export_frames).astype(np.uint8),
                hard_mask=aug_masks,
                background_frames=hole_bg_images,
                ...
                external_alpha_blend=external_alpha_blend,
                external_alpha_delta_clip=external_alpha_delta_clip,
                external_alpha_hair_boost=external_alpha_hair_boost,
